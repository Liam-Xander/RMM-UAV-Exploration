...
// void EDTEnvironment::setMapROS(shared_ptr<MapROS>& ros) {
//   this->map_ros_ = ros;
// }
...
// Get the distance values of the 8 surrounding points, used for subsequent trilinear interpolation calculations
...
// Perform trilinear interpolation calculation
void EDTEnvironment::interpolateTrilinear(double values[2][2][2], const Eigen::Vector3d& diff,
                                          double& value, Eigen::Vector3d& grad) {
 
/* Parameters:
   values: values at the 8 vertices
   diff: relative coordinates of the interpolation position */
